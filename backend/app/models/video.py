...
class OperationVideo(SQLModel, table=True):
    ...
    description: Optional[str] = Field(default=None, sa_column=Column(TEXT), description="视频描述")
    video_url: str = Field(max_length=500, description="视频URL路径")
    cover_image: Optional[str] = Field(default=None, max_length=500, description="封面图URL路径")
