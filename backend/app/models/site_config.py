...
class SiteConfig(SQLModel, table=True):
    ...
    description: Optional[str] = Field(default=None, max_length=255, description="配置描述")
    updated_at: datetime = Field(default_factory=datetime.utcnow, description="更新时间")
    updated_by: Optional[int] = Field(default=None, foreign_key="sys_users.id", description="更新人ID")
